...
- If the workbook has a `theme{N}.xml` part, holds its [`ThemePalette`](color.en.md) ([Issue #76](https://github.com/MinamiyamaKotaro/exceldiff/issues/76) — see Open Question 4 below)
...
pub struct Workbook {
    ...
    /// resolve API"
    /// ([Issue #76 design proposal](https://github.com/MinamiyamaKotaro/exceldiff/issues/76#issuecomment-5352309575))
