...
- None of the above XXE-related tests are repeated in individual `parse/*.rs` files (per the [PR #9 review](https://github.com/MinamiyamaKotaro/exceldiff/pull/9#pullrequestreview-4948641204), they are centralized here, where `read_event` is defined)
